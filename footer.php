...
-->
		...
		<div id="footer-bottominfo">
			<ul>
				<li>&copy; <?php echo date("Y"); ?> <a href="http://www.greyhoundlifeline.co.uk/" title="Adopt a Greyhound from Greyhound Lifeline">Greyhound Lifeline</a> - Finds loving homes for greyhounds and is run by volunteers (Registered Charity number 1173175)</li>
